...
const AddTodos = () => {
  ...
  return (
    <form onSubmit={addTodoHandler} className="space-x-3 mt-12 flex mb-1">
      <input
        type="text"
      ...
      <button
        type="submit"
        className="text-white bg-indigo-500 border-0 p-2 w-[35%] focus:outline-none hover:bg-indigo-600 rounded text-lg"
      >
        Add Todo
      </button>
    </form>
